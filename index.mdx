...
FORGE is the **base you fork** to build a fantasy or roleplay server on [HELIX](https://helixgame.com), the ESX/QBCore (FiveM) or VORP/RSG (RedM) of the HELIX world. It ships characters, attributes,
